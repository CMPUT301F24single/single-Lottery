 ...
 * including event count queries and navigation to organizer details.
 *
 * @author [Jingyao Gu]
 * @author [Aaron kim]
 * @version 1.0
...
public class AdminOrganizerAdapter extends RecyclerView.Adapter<AdminOrganizerAdapter.OrganizerViewHolder> {
    ...
    public static class OrganizerViewHolder extends RecyclerView.ViewHolder {
         ...
         * Sets up name, ID, event count display and click listeners.
         * Queries Firestore for organizer's event count.
         *
